...
async function main() {
    ...
    const smartContractToDeploy = 'Box'; // Define the name of the smart contract to deploy
    ...
    txSmartContractDeployment.maxPriorityFeePerGas = ethers.parseUnits("15", "gwei"); // Set the maximum priority fee per gas
    txSmartContractDeployment.maxFeePerGas = ethers.parseUnits("20", "gwei"); // Set the maximum fee per gas
